...
for acdatefolder in sorted(os.listdir(slavefolder)):
	...
	'''
	add more parameter to determinate swath and burst
	'''
    ...
    '''
    read+read(2) -> SliceAssambly -> TOPSAR-Split -> Apply-Orbit-File -> Write
    Inputfile                    IWs/VV/burst 1-9999
    '''                                  
    if len(files) > 1 :
